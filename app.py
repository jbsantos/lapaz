# -*- coding: utf-8 -*-
from flask import Flask, request, redirect, render_template, Response, json, abort, url_for
...
def create_app(config_name):
    ...
    app.config['BABEL_DEFAULT_LOCATE'] = 'pt'
    babel = Babel(app)
    ...
    def auth_token_required(f):
        ...
        def verify_token(*args, **kwargs):
            ...
            try:
                ...
                abort(401, 'Você precisa enviar um token de acesso sadf')
    ...
    @app.route('/missao/', methods=['POST', 'GET'])
    def missao():
        print('chegou aqui')
        return redirect(url_for("/admin/missao/edit/?id=7"))
    ...
    return app.run(host='10.80.16.21', port=8001)
    #return app
